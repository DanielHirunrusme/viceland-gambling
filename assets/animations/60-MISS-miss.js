...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:784.7,y:63.5},16).to({rotation:-90,x:719.8,y:92.1},4).to({rotation:-180,x:708.1,y:-38.5},4).to({x:452.6},11).to({x:254.7,y:420.7},14).to({rotation:0,x:166.5,y:349.8},8).wait(3));
