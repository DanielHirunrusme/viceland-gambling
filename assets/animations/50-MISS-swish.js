...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:784.7,y:63.5},15).to({rotation:-90,x:748.7,y:103.3},3).to({x:759.1,y:114.5},3).to({x:743,y:115.1},3).to({x:753.1,y:66.2},3).to({y:50.6},2).to({rotation:-135,x:755,y:114.6},3).to({rotation:-180,x:753.2,y:423.1},7).to({scaleY:0.86,y:426.3},1).to({scaleY:1,y:423.1},1).to({rotation:0,x:166.5,y:349.8},16).wait(3));
