...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:469.5,y:37.9},9).to({rotation:90,x:784.7,y:74.5},9).to({rotation:0,x:746.8,y:111.1},5).to({x:762,y:110.3},2).to({x:746.8,y:111.1},2).to({x:762,y:110.3},2).to({rotation:-180,x:635.6,y:55.3},5).to({rotation:-270,x:306.8,y:420.1},16).to({rotation:-360,x:166.5,y:349.8},5).wait(5));
