...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:361.5,y:83.5},6).to({rotation:90,x:588.7,y:50.5},7).to({rotation:180,x:761.1,y:98.6},7).to({regX:22.4,rotation:60,x:748.3,y:103.2},3).to({regX:22.5,regY:22.6,rotation:-36,x:673.2,y:64.8},5).to({regX:22.4,regY:22.5,rotation:-165,x:373.9,y:268},16).to({regX:22.5,rotation:-180,x:194.8,y:423.1},7).to({rotation:0,x:166.5,y:349.8},6).wait(3));
