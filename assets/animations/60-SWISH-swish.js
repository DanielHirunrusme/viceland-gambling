...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:361.5,y:83.5},10).to({rotation:90,x:588.7,y:50.5},10).to({rotation:180,x:761.1,y:98.6},11).to({regX:22.4,regY:22.6,x:758.3,y:417.6},9).to({regX:22.5,regY:22.5,rotation:0,x:166.5,y:349.8},17).wait(3));
