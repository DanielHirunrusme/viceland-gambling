...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:469.5,y:37.9},15).to({rotation:90,x:748.7,y:71.3},12).to({rotation:180,x:753.2,y:423.1},12).to({scaleY:0.86,y:426.3},1).to({scaleY:1,y:423.1},1).to({rotation:0,x:166.5,y:349.8},16).wait(3));
