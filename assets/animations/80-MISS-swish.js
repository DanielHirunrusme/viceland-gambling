...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:566.2,y:85.1},13).to({rotation:90,x:784.7,y:68.7},10).to({rotation:0,x:719.8,y:92.1},8).to({regY:22.4,rotation:-30,x:711.5,y:95},8).to({regX:22.4,rotation:-15,x:713.9,y:92.6},7).to({regY:22.5,rotation:30,x:749.8,y:95},6).to({regX:22.5,rotation:90,x:764.9,y:417.8},7).to({rotation:0,x:454.4,y:375.4},12).to({rotation:-90,x:209.7,y:417.8},8).to({rotation:0,x:166.5,y:349.8},7).to({startPosition:0},4).wait(1));
