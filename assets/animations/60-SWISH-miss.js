...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:361.5,y:83.5},7).to({rotation:90,x:588.7,y:50.5},7).to({rotation:180,x:761.1,y:98.6},7).to({regX:22.4,regY:22.6,rotation:135,x:738.2,y:93.8},2).to({regY:22.5,rotation:180,x:784.8,y:77.1},4).to({rotation:90,x:542.4,y:92.1},15).to({regX:22.5,rotation:0,x:166.5,y:349.8},15).wait(3));
