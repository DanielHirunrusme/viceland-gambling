...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:784.7,y:63.5},24).to({rotation:-90,x:517.5,y:127.9},10).to({rotation:-180,x:230.2,y:423.1},13).to({rotation:0,x:166.5,y:349.8},5).wait(8));
