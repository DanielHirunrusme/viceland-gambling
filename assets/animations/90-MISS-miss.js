...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:566.2,y:36.3},13).to({rotation:90,x:877.5,y:-130.5},10).to({x:347.9,y:-38.5},13).to({rotation:0,x:183,y:423.1},11).to({x:166.5,y:349.8},5).wait(8));
