...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:469.5,y:37.9},15).to({rotation:90,x:784.7,y:74.5},12).to({rotation:0,x:753.2,y:119.1},7).to({rotation:-180,y:423.1},9).to({rotation:0,x:166.5,y:349.8},14).wait(3));
