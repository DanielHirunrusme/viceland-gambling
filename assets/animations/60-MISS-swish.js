...
(lib.FTidle = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(30).to({_off:false},0).to({rotation:0,x:784.7,y:63.5},24).to({rotation:-90,x:748.7,y:103.3},3).to({x:759.1,y:114.5},3).to({x:743,y:131.1},3).to({x:761.1,y:149.4},3).to({x:755.3,y:185.8},3).to({rotation:-180,x:753.1,y:423.1},7).to({rotation:0,x:166.5,y:349.8},11).wait(3));
